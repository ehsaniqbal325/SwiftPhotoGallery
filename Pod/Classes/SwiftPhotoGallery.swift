...
@objc public protocol SwiftPhotoGalleryDelegate {
    ...
    @objc optional func galleryDidTapToRedo(gallery:SwiftPhotoGallery)
    @objc optional func galleryDidTapFeedBack(gallery:SwiftPhotoGallery , viewPassed:UIView)
    @objc optional func galleryDidTapManualRemoval(gallery:SwiftPhotoGallery)
}
...
public class SwiftPhotoGallery: UIViewController {
    ...
    @objc func FeedbackButtonAction(sender: UIButton!) {
        delegate?.galleryDidTapFeedBack?(gallery: self ,viewPassed: view)
    }
    
    @objc func ManualReleaseButtonAction(sender: UIButton!) {
        delegate?.galleryDidTapManualRemoval?(gallery: self)
    }
    
    
    @objc func RedoButtonAction(sender: UIButton!) {
        delegate?.galleryDidTapToRedo?(gallery: self)
    }
    ...
    func addCustomButtons(){
        ...
        let button = UIButton(frame: CGRect(x: self.view.layer.frame.size.width - 40 , y: 40, width: 30, height: 30))
        ...
        let buttonRedo = UIButton(frame: CGRect(x: 10 , y: 40, width: 35, height: 35))
        buttonRedo.backgroundColor = .clear
        buttonRedo.titleLabel?.textColor = .white
        buttonRedo.setTitle("", for: .normal)
        buttonRedo.setImage(UIImage.init(named: "Redo"), for: UIControl.State.normal)
        buttonRedo.tintColor = .black
        buttonRedo.addTarget(self, action: #selector(RedoButtonAction), for: .touchUpInside)
        
        
        
        let buttonFeedBack = UIButton(frame: CGRect(x: 50 , y: 40, width: 40, height: 40))
        buttonFeedBack.backgroundColor = .clear
        buttonFeedBack.titleLabel?.textColor = .white
        buttonFeedBack.setTitle("", for: .normal)
        buttonFeedBack.setImage(UIImage.init(named: "Feedback"), for: UIControl.State.normal)
        buttonFeedBack.tintColor = .black
        buttonFeedBack.addTarget(self, action: #selector(FeedbackButtonAction), for: .touchUpInside)
        
        
        let buttonManualRelease = UIButton(frame: CGRect(x: 90 , y: 40, width: 40, height: 40))
        buttonManualRelease.backgroundColor = .clear
        buttonManualRelease.titleLabel?.textColor = .white
        buttonManualRelease.setTitle("", for: .normal)
        buttonManualRelease.setImage(UIImage.init(named: "ManualRelease"), for: UIControl.State.normal)
        buttonManualRelease.tintColor = .black
        buttonManualRelease.addTarget(self, action: #selector(ManualReleaseButtonAction), for: .touchUpInside)
        
        self.view.addSubview(button)
        if(self.isEditingMood){
            self.view.addSubview(buttonRedo)
            self.view.addSubview(buttonFeedBack)
            self.view.addSubview(buttonManualRelease)
        }
    }
